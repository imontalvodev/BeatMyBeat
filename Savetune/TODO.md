...
Requerimos de una cuenta premium de Spotify para acceder a la API web y obtener las playlists
PROBLEMAS: 

- Necesitamos que el usuario sea colaborador de la playlist, para ello tendremos que crear nosotros un usuario y ver como meterlo en dicha playlist, util para playlists personales de cada usuario pero problema para playlist publica tocha

- La API cambia constantemente, habria que tenerla vigilada y estudiarla
