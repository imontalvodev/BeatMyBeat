...
| Versión instalada | `BuildConfig.VERSION_NAME` (p. ej. `1.0.0`) |
| Versión remota | `tag_name` del release sin prefijo `v` (p. ej. `v1.0.1` → `1.0.1`) |
...
> Si compilas e instalas `1.0.1` mientras GitHub sigue en `1.0.0`, **no verás aviso** (comportamiento correcto).
